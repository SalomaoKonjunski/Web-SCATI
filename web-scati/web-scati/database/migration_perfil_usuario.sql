-- =====================================================================
-- Web SCATI - Migração: perfil de usuário (Administrador / Padrão / Solicitante)
-- =====================================================================
...
--
-- O novo perfil "Solicitante" só tem acesso à aba de Chamados: pode
-- registrar chamados e acompanhar os que ele mesmo abriu, mas não
-- enxerga o restante do sistema nem pode editar/excluir chamados.
--
-- Rode uma única vez:
...
ALTER TABLE usuarios
    ADD COLUMN perfil ENUM('Administrador','Padrão','Solicitante') NOT NULL DEFAULT 'Padrão' AFTER admin;

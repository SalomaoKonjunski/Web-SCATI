...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <span class="small text-muted">Visível só para você. Arraste um cartão pelo <i class="bi bi-grip-vertical"></i> para reordenar.</span>
    </div>
...
<?php else: ?>
    <div class="row g-3" id="notasGrid">

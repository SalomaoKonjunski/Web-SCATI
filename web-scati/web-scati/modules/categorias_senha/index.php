...
$pdo = db();
$pageTitle = 'Categorias de Senhas';

$categorias = $pdo->query(
    'SELECT c.*, COUNT(s.id) AS total_senhas
     FROM categorias_senha c
     LEFT JOIN senhas s ON s.categoria = c.nome
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        <h1 class="h3 mb-0"><i class="bi bi-shield-lock me-2"></i>Categorias de Senhas</h1>
            ...
            <tbody>
                ...
                <?php foreach ($categorias as $cat): ?>
                    <tr>
                        ...
                        <td class="text-center"><span class="badge bg-secondary"><?= (int) $cat['total_senhas'] ?></span></td>
                        <td class="text-end">

    ...
    if (notifBtn && notifBadge) {
        ...
        function renderizarMenuNotificacao(itens) {
            ...
            itens.forEach(function (item) {
                ...
                // A caixa inteira do item fica pintada conforme o tipo:
                // solicitação nova (chamado nunca aberto) ou mensagem nova
                // (resposta ainda não lida, num azul um pouco mais forte).
                link.className = 'dropdown-item scati-notif-item py-2 border-bottom '
                    + (item.tipo === 'solicitacao' ? 'scati-notif-solicitacao' : 'scati-notif-mensagem');
